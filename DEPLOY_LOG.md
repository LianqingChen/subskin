...
|------|------|---------|-----------|
| 2026-06-19 | 测评页 Step1+分享 | **2项功能增强**：①上传照片后自动滚动到"开始AI分析"按钮——原来watch监听imagePreview滚动到actionCardRef(卡片顶部)，小屏幕下按钮仍在折叠区。改为新增submitBtnRef，滚动目标优先指向按钮本身。②分享帖子时封面图改为标注图(原图+皮肤蓝层+白斑粉层合成)作为第1张+原始上传照片作为第2张。MaskEditor新增getAnnotatedImageDataUrl()导出合成图；useVasiAssess新增annotatedImage状态；onShareResult优先使用annotatedImage；onSkipContour路径也通过composeAnnotatedImage从AI图层URL合成 | 1781884068332 |

## Production Deployment History

> Latest: 2026-06-19 — buildTime: 1781831937868
