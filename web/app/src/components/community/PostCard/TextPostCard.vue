...
<template>
  <router-link
    ...
    class="block no-underline mb-3 rounded-xl overflow-hidden bg-white shadow-sm hover:shadow-md transition-all duration-200 group p-3.5"
  >
    <p class="text-[13px] text-gray-800 leading-relaxed line-clamp-4 mb-2">
