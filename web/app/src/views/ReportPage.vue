...
<template>
  <div class="" style="background-color: #f7f7f7">
    ...
    <div class="fixed top-[6vh] left-0 right-0 z-0 " style="background-color: #f7f7f7; height: 55vh; min-height: 360px">
    ...
    <div data-view-card class="relative z-10 bg-white  rounded-t-3xl shadow-[0_-8px_30px_rgba(0,0,0,0.08)]"
      style="margin-top: 55vh;">
      <div class="max-w-6xl mx-auto px-4 pt-3 pb-24 md:pb-8">
        <div class="flex items-center justify-between mb-2">
          <div>
            <h1 class="text-xl font-bold text-gray-800 ">体检解读</h1>
            <p class="text-sm text-gray-500 ">上传体检报告，AI 自动解读</p>
          </div>
        </div>
        <ReportUploader />
      </div>
