...
<template>
  <div class="dark:bg-gray-900" style="background-color: #f7f7f7">
    <!-- Panda — fixed, never moves -->
    <div class="fixed top-[6vh] left-0 right-0 z-0 dark:bg-gray-900" style="background-color: #f7f7f7; height: 55vh; min-height: 360px">
